...
export async function generateMetadata(): Promise<Metadata> {
    ...
    try {
        ...
        console.error("[MayorAccountLayout Metadata] Failed to fetch mayor village:", error);
    }

    return {
        title: `AgriCad - Contul Meu (${villageName})`, // Dynamic title
        description: `Gestionează setările contului pentru primarul din ${villageName}`, // Dynamic description
    };
}


export default function MayorAccountLayout({
  children,
}: Readonly<{
