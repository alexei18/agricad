...
export async function generateMetadata(): Promise<Metadata> {
    ...
    try {
        ...
        console.error("[MayorFarmersLayout Metadata] Failed to fetch mayor village:", error);
    }

  return {
    title: `AgriCad - Gestionare Agricultori (${villageName})`, // Updated title
    description: `Gestionează agricultorii înregistrați în ${villageName}`, // Updated description
  };
}


export default function MayorFarmersLayout({
  children,
}: Readonly<{
